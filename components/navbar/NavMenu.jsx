...
export default function NavMenu() {
  return (
    <StyledMenubar>
      <MenubarMenu>
        <StyledMenubarTrigger>Products</StyledMenubarTrigger>
        <MenubarContent>
          <Link href="/products">
      ...
      <MenubarMenu>
        <StyledMenubarTrigger>Edit</StyledMenubarTrigger>
        <MenubarContent>
          <MenubarItem>
      ...
      <MenubarMenu>
        <StyledMenubarTrigger>View</StyledMenubarTrigger>
        <MenubarContent>
      ...
      <MenubarMenu>
        <StyledMenubarTrigger>Profiles</StyledMenubarTrigger>
        <MenubarContent>
